...
- 🚀 Experienced in building REST APIs, SaaS workflows, and database-driven applications  
...
### Backend
`ASP.NET Core` • `Node.js` • `Java` • `REST APIs` • `Microservices`
